...
#[cfg(test)]
fn core_rate_limit_error_kind(
    info: &codex_protocol::protocol::CodexErrorInfo,
...
#[cfg(test)]
fn is_core_cyber_policy_error(info: &codex_protocol::protocol::CodexErrorInfo) -> bool {
    matches!(info, codex_protocol::protocol::CodexErrorInfo::CyberPolicy)
}
...
#[cfg(test)]
fn token_usage_info_from_protocol(
    token_usage: codex_protocol::protocol::TokenUsageInfo,
) -> TokenUsageInfo {
    TokenUsageInfo {
        total_token_usage: TokenUsage {
            total_tokens: token_usage.total_token_usage.total_tokens,
            input_tokens: token_usage.total_token_usage.input_tokens,
            cached_input_tokens: token_usage.total_token_usage.cached_input_tokens,
            output_tokens: token_usage.total_token_usage.output_tokens,
            reasoning_output_tokens: token_usage.total_token_usage.reasoning_output_tokens,
        },
        last_token_usage: TokenUsage {
            total_tokens: token_usage.last_token_usage.total_tokens,
            input_tokens: token_usage.last_token_usage.input_tokens,
            cached_input_tokens: token_usage.last_token_usage.cached_input_tokens,
            output_tokens: token_usage.last_token_usage.output_tokens,
            reasoning_output_tokens: token_usage.last_token_usage.reasoning_output_tokens,
        },
        model_context_window: token_usage.model_context_window,
    }
}
    ...
    fn dispatch_event_msg(
        ...
        match msg {
            EventMsg::TurnStarted(event) => {
                self.turn_lifecycle.last_turn_id = Some(event.turn_id);
            ...
            EventMsg::TokenCount(ev) => {
                self.set_token_info(ev.info.map(token_usage_info_from_protocol));
            }
        ...
        if !from_replay && self.turn_lifecycle.agent_turn_running {
            self.refresh_runtime_metrics();
        }
    }
