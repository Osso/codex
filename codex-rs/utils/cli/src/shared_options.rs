...
pub struct SharedCliOptions {
    ...
    /// Specify which local provider to use (ollama).
    ...
    /// Create or reuse a sibling Git worktree and use it as the working root.
    #[clap(long = "worktree", short = 'w', value_name = "NAME")]
